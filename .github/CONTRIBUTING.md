# Contribute to ACadSharp.Formats

## Report bugs

- Before creating a new issue, please ensure the bug was not already reported or there is already a similar one 
by searching on GitHub under [issues](https://github.com/DomCR/ACadSharp.Formats/issues).
- Otherwise [open an issue](https://github.com/DomCR/ACadSharp.Formats/issues/new?template=bug_report.md) addressing the problem. Please try to follow the template which helps to identify the problem faster.
...
- Use the following [template](https://github.com/DomCR/ACadSharp.Formats/issues/new?template=feature_request.md) to propose a new feature.
